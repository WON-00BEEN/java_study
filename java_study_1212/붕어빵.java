...
public class 붕어빵 {
	...
	public static void main(String[] args) {
		...
		붕어빵기계 길동이네붕어빵 = new 붕어빵기계(1000, "팥");//생성자로 필드변수 초기화
		System.out.println("붕어빵 가격: "+길동이네붕어빵.붕어빵가격);//필드변수 출력
        ...
        붕어빵기계 철수네붕어빵 = new 붕어빵기계(700, "슈크림");//생성자로 필드변수 초기화
        System.out.println("붕어빵 가격: "+철수네붕어빵.붕어빵가격);//필드변수 출력
